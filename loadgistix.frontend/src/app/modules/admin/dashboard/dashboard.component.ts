    ...
    initPage() {
        ...
        this._analyticsService.getData()
            ...
            .subscribe((data) => {
                ...
                this.sqlService.createItem('dashboard', { action: 'unique-visotors-week', userId: this.currentUser ? this.currentUser.id : '00000000-0000-0000-0000-000000000000' }).subscribe((result1) => {
                    // Ensure data is an array for charts
                    if (Array.isArray(result1?.data)) {
                        this.data.visitors.series['this-week'][0].data = result1.data;
                    }
                    this.sqlService.createItem('dashboard', { action: 'unique-visotors-year', userId: this.currentUser ? this.currentUser.id : '00000000-0000-0000-0000-000000000000' }).subscribe((result2) => {
                        // Ensure data is an array for charts
                        if (Array.isArray(result2?.data)) {
                            this.data.visitors.series['this-year'][0].data = result2.data;
                        }
