...
@Component({
    selector: 'dialog-maintenancePlannedType',
    templateUrl: 'dialog-maintenancePlannedType.component.html',
    standalone: true,
...
export class DialogMaintenancePlannedTypeComponent implements OnDestroy {
    ...
    constructor(
        ...
        public dialogRef: MatDialogRef<DialogMaintenancePlannedTypeComponent>,
    ...
    async initDelete(id: any) {
        ...
        confirmation.afterClosed().pipe(takeUntil(this._unsubscribeAll)).subscribe((result) => {
            if (result === 'confirmed') {
                ...
                this.sqlService.deleteItem('maintenancePlannedTypes', id).pipe(takeUntil(this._unsubscribeAll)).subscribe(() => {
