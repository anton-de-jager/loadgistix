...
@Component({
    selector: 'dialog-companyType',
    templateUrl: 'dialog-companyType.component.html',
    standalone: true,
...
export class DialogCompanyTypeComponent implements OnDestroy {
    ...
    constructor(
        ...
        public dialogRef: MatDialogRef<DialogCompanyTypeComponent>,
    ...
    async initDelete(id: any) {
        ...
        confirmation.afterClosed()
            ...
            if (result === 'confirmed') {
                ...
                this.sqlService.deleteItem('companyTypes', id)
