...
@Component({
    selector: 'dialog-maintenanceUnPlannedType',
    templateUrl: 'dialog-maintenanceUnPlannedType.component.html',
    standalone: true,
...
export class DialogMaintenanceUnPlannedTypeComponent implements OnDestroy {
    ...
    constructor(
        ...
        public dialogRef: MatDialogRef<DialogMaintenanceUnPlannedTypeComponent>,
    ...
    async initDelete(id: any) {
        ...
        confirmation.afterClosed().pipe(takeUntil(this._unsubscribeAll)).subscribe((result) => {
            if (result === 'confirmed') {
                ...
                this.sqlService.deleteItem('maintenanceUnPlannedTypes', id).pipe(takeUntil(this._unsubscribeAll)).subscribe(() => {
