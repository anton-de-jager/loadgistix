...
@Component({
    selector: 'dialog-returnReason',
    templateUrl: 'dialog-returnReason.component.html',
    standalone: true,
...
export class DialogReturnReasonComponent implements OnDestroy {
    ...
    constructor(
        ...
        public dialogRef: MatDialogRef<DialogReturnReasonComponent>,
    ...
    async initDelete(id: any) {
        ...
        confirmation.afterClosed().pipe(takeUntil(this._unsubscribeAll)).subscribe((result) => {
            if (result === 'confirmed') {
                ...
                this.sqlService.deleteItem('returnReasons', id).pipe(takeUntil(this._unsubscribeAll)).subscribe(() => {
