...
@Component({
    selector: 'dialog-pdp-group',
    templateUrl: 'dialog-pdp-group.component.html',
    standalone: true,
...
export class DialogPdpGroupComponent implements OnDestroy {
    ...
    constructor(
        ...
        public dialogRef: MatDialogRef<DialogPdpGroupComponent>,
    ...
    async initDelete(id: any) {
        ...
        confirmation.afterClosed().pipe(takeUntil(this._unsubscribeAll)).subscribe((result) => {
            if (result === 'confirmed') {
                ...
                this.sqlService.deleteItem('pdpGroups', id).pipe(takeUntil(this._unsubscribeAll)).subscribe(() => {
