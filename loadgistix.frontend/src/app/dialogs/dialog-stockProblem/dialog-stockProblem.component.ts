...
@Component({
    selector: 'dialog-stockProblem',
    templateUrl: 'dialog-stockProblem.component.html',
    standalone: true,
...
export class DialogStockProblemComponent implements OnDestroy {
    ...
    constructor(
        ...
        public dialogRef: MatDialogRef<DialogStockProblemComponent>,
    ...
    async initDelete(id: any) {
        ...
        confirmation.afterClosed().pipe(takeUntil(this._unsubscribeAll)).subscribe((result) => {
            if (result === 'confirmed') {
                ...
                this.sqlService.deleteItem('stockProblems', id).pipe(takeUntil(this._unsubscribeAll)).subscribe(() => {
