...
@Component({
    selector: 'dialog-axel',
    templateUrl: 'dialog-axel.component.html',
    standalone: true,
...
export class DialogAxelComponent implements OnDestroy {
    ...
    constructor(
        ...
        public dialogRef: MatDialogRef<DialogAxelComponent>,
    ...
    async initDelete(id: any) {
        ...
        confirmation.afterClosed()
            ...
            if (result === 'confirmed') {
                ...
                this.sqlService.deleteItem('axels', id)
