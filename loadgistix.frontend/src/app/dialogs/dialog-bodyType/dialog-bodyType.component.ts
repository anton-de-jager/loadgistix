...
@Component({
    selector: 'dialog-bodyType',
    templateUrl: 'dialog-bodyType.component.html',
    standalone: true,
...
export class DialogBodyTypeComponent implements OnDestroy {
    ...
    constructor(
        ...
        public dialogRef: MatDialogRef<DialogBodyTypeComponent>,
    ...
    async initDelete(id: any) {
        ...
        confirmation.afterClosed()
            ...
            if (result === 'confirmed') {
                ...
                this.sqlService.deleteItem('bodyTypes', id)
